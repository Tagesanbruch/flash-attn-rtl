module fa_online_softmax_ctx (
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    int idx;
    logic signed [15:0] m_prev;
    logic [31:0]        l_prev;
    logic signed [31:0] acc_prev;
    ...
    if (!rst_n) begin
      ...
      if (i_valid) begin
        idx = i_ctx_id[0];
        m_prev = i_row_start ? -16'sd32768 : m_state[idx];
        l_prev = i_row_start ? 32'd0 : l_state[idx];
        acc_prev = i_row_start ? 32'sd0 : acc_state[idx];
        m_new = (i_score_q8_8 > m_prev) ? i_score_q8_8 : m_prev;
        diff_old_q8_8 = m_prev - m_new;
        diff_new_q8_8 = i_score_q8_8 - m_new;
        exp_old_q1_15 = exp2_approx(diff_old_q8_8);
        exp_new_q1_15 = exp2_approx(diff_new_q8_8);
        l_scaled_q32_31 = l_prev * exp_old_q1_15;
        l_new_q16_16 = l_scaled_q32_31[46:15] + {15'd0, exp_new_q1_15, 1'b0};
        acc_scaled_q33_31 = acc_prev * $signed({1'b0, exp_old_q1_15});
