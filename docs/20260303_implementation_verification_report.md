...
| 指标 | 赛题要求 | 实测值 | 通过 |
|------|----------|--------|------|
| MAX_AE (Q8.8 integer) | — | **0** | ✅ |
| MAE (Q8.8 integer) | — | **0.00** | ✅ |
| MAX_AE (浮点等效) | ≤ 0.10 | **0.000** | ✅ |
| MAE (浮点等效) | ≤ 0.03 | **0.000** | ✅ |

> 注: Python golden reference 使用与 RTL 完全相同的定点算术路径 (exp_pwl / q8_8_mul_sat / recip_nr)，
> 因此 RTL 与 golden 之间误差为 0。与 FP32 golden 的误差需额外测试。
...
| S=256, D=64 端到端 | ✅ | MAX_AE=0, MAE=0.00 |
| 周期数 < 300k | ❌ | 4.5M (需并行优化) |
